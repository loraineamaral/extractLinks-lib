...
describe("findURLsInText", () => {
  ...
  it("Testa se existem links no arquivo e retorna 1 link", () => {
    expect(textString.findURLsInText("`#Lorem ipsum Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor  incididunt ut [labore](https://en.wiktionary.org/wiki/labore).`;")).to.deep.equal([ { href: 'https://en.wiktionary.org/wiki/labore',
    text: 'labore' } ])
});
});
